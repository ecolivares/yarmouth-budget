...
function systemPrompt() {
  ...
  var facts = {
    ...
    mechanics: {
      ...
      standard_home_fy27_bill: M.homeBillFY27,
  ...
  return [
    ...
    "- CONVERSION FACTOR: every $1,000,000 cut ≈ −$" + M.ratePerMillion + " on the rate ≈ −$" + M.homePerMillion + "/year on a $" + M.home + " home (FY27 bill ≈ $" + M.homeBillFY27 + ").",
    "",
    "HOW TO ANSWER:",
